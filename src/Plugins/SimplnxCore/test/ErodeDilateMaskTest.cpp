...
MaskLiteralFixture CreateMaskLiteralFixture(const usize dimX, const usize dimY, const usize dimZ, const std::array<bool, 4>& maskValues)
{
  ...
  auto maskStore = DataStoreUtilities::CreateDataStore<bool>(fixture.dataStructure, fixture.maskPath, cellTupleShape, {1}, IDataAction::Mode::Execute);
  ...
  auto siblingValuesStore = DataStoreUtilities::CreateDataStore<int32>(fixture.dataStructure, fixture.siblingValuesPath, cellTupleShape, {1}, IDataAction::Mode::Execute);
